...
//Just a for loop around the above test case where we print out the times for different solver runs
//This shows good linear perfomance and sub linear perfomance
/*
struct TestCase {
    std::string category;
    int m1;
