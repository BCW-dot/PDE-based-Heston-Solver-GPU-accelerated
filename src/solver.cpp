...
//plots the option surface where you can see divident impacts
void test_heston_divident_put_price_surface() {
    ...
    // Solve using DO scheme
    //for( int i = 0; i<15; i++){
        DO_scheme_dividend_shuffled_with_surface_tracking_put(
            m,              // Total size
            m1,             // Stock price points
            m2,             // Variance points
            N,              // Time steps
...
void test_lambda_american_dividend_put() {
    ...
    //for dividends
    std::vector<double> dividend_dates = {0.2, 0.4, 0.6, 0.8};
    std::vector<double> dividend_amounts = {0.02, 0.02, 0.02, 0.02};
    std::vector<double> dividend_percentages = {0.02, 0.02, 0.02, 0.02};

    auto device_Vec_s = grid.device_Vec_s;

    // Solve using DO scheme
    DO_scheme_american_dividend_shuffle_with_lambda_tracking_put(
        m, m1, m2, N, U_0, delta_t, theta, 
        dividend_dates,
        dividend_amounts,
        dividend_percentages,
